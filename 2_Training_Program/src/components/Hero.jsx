    ...
    return (
        <>
            ...
            <ol className="benefits-list">
                ...
                <li>Get fit, healthy, strong, shredded</li>
                <li>Learn more about training and technique</li>
            ...
            <small>* The first and second set should be at 75% and 85% of your working wieght used for the last two sets.</small>
            <h3>The Training Plan</h3>
            <p>This training plan uses a structure kown as the <b>Bro Split</b>, and follows this rotation ⬇️</p>
