...
export default function WorkoutCard(props) {
    ...
    //const showExerciseDescription = { name: 'asdfg', description: 'djerfdkfednbnb' }

    return (
        <div className="workout-container">
            {showExerciseDescription && (<Modal showExerciseDescription={showExerciseDescription} handleCloseModal={() => { setShowExerciseDescription(null) }} />)}
